...
class GraphTransformerLayer(nn.Module):
    ...
    def forward(self, g, node_feats, edge_feats):
        ...
        node_feats_in2 = node_feats  # Caching node representations for second residual connection
        edge_feats_in2 = edge_feats  # Caching edge representations for second residual connection
